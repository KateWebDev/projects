...
function QuizProvider({ children }) {
  ...
  const { data, status, currentIndex, answer, points, maxPoints, timer } = state;
  ...
  return <ContextQuiz.Provider value={value}>{children}</ContextQuiz.Provider>;
}

export { ContextQuiz, QuizProvider };
